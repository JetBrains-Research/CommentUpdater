...
object JITModelFeatureExtractor{
    ...
    val STOP_WORDS = listOf("i", "me", "my", "myself", "we", 
    ...
    val JAVA_KEYWORDS = listOf("abstract", "assert", "boolean", "break", "byte", "case", "catch", "char", "class",
    ...
    fun getCodeFeatures(spanSequence: List<String>, commentTokens: List<String>,
                        oldFeatures:  HashMap<String, List<String>>, newFeatures:  HashMap<String, List<String>>,
                        maxCodeLen: Int): Array<IntArray> {
        ...
        for(it in spanSequence.withIndex()) {
            ...
            } else if(it.value in JAVA_KEYWORDS) {
                features[it.index][9] = 1

            } else if(it.value.all { !it.isLetterOrDigit() }) {
                // is operator
                features[it.index][10] = 1
            } else if(it.value in commentTokensSet) {
    ...
    fun getCommentFeatures(oldCommentTokens: List<String>, oldCommentSubTokens: List<String>, tokenDiffCodeSubTokens: List<String>,
                           oldCodeFeatures:  HashMap<String, List<String>>, newCodeFeatures:  HashMap<String, List<String>>,
                           maxCommentLen: Int): Array<IntArray> {
