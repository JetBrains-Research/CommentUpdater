...
internal fun initRepo(project: Project, repoRoot: String, makeInitialCommit: Boolean) {
  cd(repoRoot)
  git(project, "init")
...
private fun setupLocalIgnore(repoRoot: String) {
...
internal fun createRepository(project: Project, root: String, makeInitialCommit: Boolean): GitRepository {
  initRepo(project, root, makeInitialCommit)
  LocalFileSystem.getInstance().refreshAndFindFileByIoFile(File(root, GitUtil.DOT_GIT))
...
internal fun registerRepo(project: Project, root: String): GitRepository {
