...
import java.io.File
import PluginRunner as PluginRunner
...
fun main(args: Array<String>) = PostProcessing().main(
...
class PostProcessing: CliktCommand() {
    ...
    override fun run() {
        ...
        CodeCommentExtractor.log(CodeCommentExtractor.Companion.LogLevel.INFO, "was here!")
